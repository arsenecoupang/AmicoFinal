...
if (!DRY_RUN && (!SUPABASE_URL || !SUPABASE_KEY)) {
	console.error(
		"Supabase URL or Key not provided. Set REACT_APP_SUPABASE_URL and REACT_APP_SUPABASE_ANON_KEY or SUPABASE_SERVICE_ROLE_KEY, or set DRY_RUN=true to run without Supabase.",
	);
	process.exit(1);
}
